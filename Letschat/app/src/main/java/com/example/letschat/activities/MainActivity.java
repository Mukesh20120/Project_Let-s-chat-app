...
import com.example.letschat.Adapters.RecentConversationAdapter;
...
public class MainActivity extends BaseActivity implements ConversionListner {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getToken();
        setListeners();
        listenConConversations();
    }

    private void init(){
        conversations = new ArrayList<>();
        conversationAdapter = new RecentConversationAdapter(conversations,this);
        binding.conversationRecyclerVier.setAdapter(conversationAdapter);
    ...
    private void listenConConversations(){
    ...
    private final EventListener<QuerySnapshot> eventListener = (value, error)->{
        ...
        if(value!=null){
            ...
            binding.conversationRecyclerVier.smoothScrollToPosition(0);
            binding.conversationRecyclerVier.setVisibility(View.VISIBLE);
